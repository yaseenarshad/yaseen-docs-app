...
describe('DocumentZoom', () => {
  ...
  describe('− / + step buttons (YAZ-1710)', () => {
    it.each([
      [50, 1, 75], [75, 1, 90], [90, 1, 100], [100, 1, 125], [125, 1, 150], [150, 1, 200], [200, 1, null],
      [200, -1, 150], [100, -1, 90], [75, -1, 50], [50, -1, null],
      [117, 1, 125], [117, -1, 100], [51, -1, 50], [199, 1, 200], [149, 1, 150], [151, -1, 150],
    ] as const)('stepZoom(%i, %i) → %s', (value, direction, expected) => {
