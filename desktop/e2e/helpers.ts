...
export function seededState(vault: string, file: string | null): AppState {
  ...
  state.folders = { [vault]: { expanded: [], lastFile: file, folds: {}, baseGroups: {}, topicsExpanded: [], favorites: [] } }
  return state
}
...
export function multiWindowState(wins: SeedWindow[], recentRoots: string[]): AppState {
  ...
  for (const w of wins) {
    state.folders[w.root] ??= { expanded: [], lastFile: w.file, folds: {}, baseGroups: {}, topicsExpanded: [], favorites: [] }
  }
  return state
}
